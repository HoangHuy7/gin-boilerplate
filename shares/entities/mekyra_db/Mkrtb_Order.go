...
type Mkrtb_Order struct {
	...
	Status      string               `gorm:"column:status;type:varchar(20)"` // paid / debt / delivery
	Note        string               `gorm:"column:note;type:varchar(512)"`
	CreatedAt   time.Time            `gorm:"column:created_at;autoCreateTime"`
	Items       []*Mkrtb_OrderItem   `gorm:"foreignKey:OrderId;references:Id"`
}
